...
intovalue <- read_csv("https://github.com/maia-sh/intovalue-data/raw/master/data/processed/intovalue.csv")
...
intovalue_crossreg <- read_csv("https://github.com/maia-sh/intovalue-data/raw/master/data/raw/cross-registrations.csv")
